...
function ArrowIcon({ width = 16, height = 16, fill = "#9496A0", className = "", onClick, direction = "top" }: Props) {
  ...
  return (
    <span role="img" className={arrowIconClassName} onClick={() => onClick && onClick()}>
      <svg style={{ width: `${width}px`, height: `${height}px` }} viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
